...
export const isAudio = file => file.endsWith('.mp3') || file.endsWith('.m4a') || file.endsWith('.ogg')
export const isLossLess = file => file.endsWith('.flac') || file.endsWith('.wav') || file.endsWith('.alac')
